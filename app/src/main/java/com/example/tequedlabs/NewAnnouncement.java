...
DatabaseReference databaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=findViewById(R.id.addPost);
        final ArrayList<String> list=new ArrayList<String>();
        final ArrayList<String> rollnumber = new ArrayList<String>();
        final ArrayAdapter<String> arrayAdapter= new ArrayAdapter<String>(NewAnnouncement.this,android.R.layout.simple_list_item_1,list);
...
button.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        Intent intent=new Intent(NewAnnouncement.this,AdminAnnouncement.class);
